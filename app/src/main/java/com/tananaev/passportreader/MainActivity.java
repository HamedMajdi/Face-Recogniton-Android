...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoCamera = findViewById(R.id.goto_camera);

        gotoCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(getApplicationContext(), CameraActivity.class), 0);
            }
        });
...
//            String latitude = data.getIntExtra("IDNumber", 0);
//            String longitude = data.getIntExtra("expirationDate", 0);
//            String longitude = data.getIntExtra("birthDate", 0);
//
//        }
    }
